...
function postMedicalHistoryObs(encounter) {
    ...
    var obs = {
        ...
        observations: [{
                concept_id: 9645,
                value_coded: medicalHistoryAnswer
            },
            {
                concept_id: 3720,
                value_coded: diabetesStatusAnswer
            },
            {
                concept_id: 6411,
                value_coded: diabetesTypeAnswer
            },
            {
                concept_id: 9574,
                value_coded: bleedingStatusAnswer
            },
            {
                concept_id: 9646,
                value_text: bleedingSpecify
            },
            {
                concept_id: 9575,
                value_coded: medicationStatusAnswer
            },
            {
                concept_id: 9647,
            ...
            {
                concept_id: 9576,
                value_coded: allergiesStatusAnswer
            },
            {
                concept_id: 9648,
                value_text: allergiesSpecify
            },
            {
                concept_id: 864,
                value_coded: ulcersStatusAnswer
            },
            {
                concept_id: 9649,
                value_text: ulcersSpecify
            },
            {
                concept_id: 9577,
                value_coded: itchingStatusAnswer
            },
            {
                concept_id: 9650,
                value_text: itchingSpecify
            },
            {
                concept_id: 9578,
                value_coded: urinationStatusAnswer
            },
            {
                concept_id: 9651,
                value_text: urinationSpecify
            },
            {
                concept_id: 6768,
                value_coded: otherMedicalAnswer
            },
            {
                concept_id: 9652,
                value_text: specifyOtherCondition
            }
        ]
    };
