  ...
  var tt_cancel_destination = "/views/patient_dashboard.html?patient_id=" + patientID;
    ...
    function postGenitalExamObs(encounter) {
        ...
        switch (anyAbnormalityStatus.toUpperCase()) {
            ...
            observations: [
                { concept_id: 9579, value_coded: circumcisionStatusAnswer },
                { concept_id: 9580, value_coded: phimosisStatusAnswer },
                { concept_id: 9600, value_coded: ulcerStatusAnswer },
                { concept_id: 5995, value_coded: urethralStatusAnswer },
                { concept_id: 8444, value_coded: swellingStatusAnswer },
                { concept_id: 9581, value_coded: inguinalNodesStatusAnswer },
                { concept_id: 8404, value_coded: anyAbnormalityStatusAnswer },
                { concept_id: 7215, value_text: otherAbnormalitiesSpecify }
            ]
        };
